...
- https://github.com/creativetimofficial/dashboard-generator-react/issues/10
- Other Now UI React products:
  - https://github.com/creativetimofficial/ct-dashboard-generator-pro-react/issues/31 (changed the fonts import to `~assets/fonts` and also added assets path inside `jsconfig.json` file)
  - https://github.com/creativetimofficial/ct-dashboard-generator-pro-react/issues/10 (add `scrollTop` inside the `Admin` layout)
...
### Major style changes
- `src/assets/scss/dashboard-generator/_variables.scss` (changed the fonts import to `~assets/fonts` and also added assets path inside `jsconfig.json` file)
- `src/assets/scss/dashboard-generator/_nucleo-outline.scss` (changed the fonts import to `~assets/fonts` and also added assets path inside `jsconfig.json` file)
### Deleted components
### Added components
### Deleted dependencies
### Added dependencies
...
## [1.2.0] 2019-06-07
### Major changes
- Solved https://github.com/creativetimofficial/dashboard-generator-react/issues/1
- Solved https://github.com/creativetimofficial/dashboard-generator-react/issues/3
- Solved https://github.com/creativetimofficial/dashboard-generator-react/issues/4
- Solved https://github.com/creativetimofficial/dashboard-generator-react/issues/7
...
### Bug fixing
- Github issues
  - https://github.com/creativetimofficial/dashboard-generator-react/issues/1
  - https://github.com/creativetimofficial/dashboard-generator-react/issues/4
- Added lint commands
